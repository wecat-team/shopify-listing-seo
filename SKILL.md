...
description: Write a complete Shopify product listing from a photo or a few facts about the product - product title, SEO title, meta description, URL handle, description HTML, tags and product type - and audit existing listings against the same rules. Listing fields are always written in the shop's selling language, English by default, whatever language the conversation is in. Every threshold is labelled a hard rule, a documented recommendation, or unsourced convention, so nothing is enforced that no source supports. Use this whenever someone is writing, rewriting or auditing a Shopify product listing or product description, whenever they send a product photo and ask for a listing, whenever they mention product SEO, listing SEO, meta title, meta description, product tags or storefront search, and whenever they are about to write product fields through the Shopify Admin API - even if they never say the word "SEO". Also triggers on the same requests in Vietnamese: "viết listing", "viết mô tả sản phẩm", "đăng sản phẩm Shopify", "viết tiêu đề sản phẩm", "sửa listing", "tối ưu SEO sản phẩm", "làm listing chuẩn", "viết bài đăng sản phẩm".
---
